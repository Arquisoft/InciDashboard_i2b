...
```
email: admin1@dashboard.com
password: 123456
```
Once you have logged in you will have access to a console of administration and between other actions, you will be able to set the permissions of what operators can do.
